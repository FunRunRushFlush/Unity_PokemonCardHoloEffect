...
// Prototype/reference compositor.
// The active designer-facing ShaderGraph output is currently built from visible
// nodes. Keep this file as a comparison target when rebuilding one holo layer at
// a time.
